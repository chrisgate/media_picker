...
- (void)viewDidLayoutSubviews
{
    ...
    //底部view
    CGRect frame = CGRectMake(0, kViewHeight-60-inset.bottom, kViewWidth, 60+inset.bottom);
    ...
    _btnDone.frame = CGRectMake(frame.size.width-82 - 16 -inset.right, 10, 80, 40);
}
...
//    UIImage *normalImg = GetImageWithName(@"zl_btn_circle");
    ...
    UIImage *normalImg = GetImageWithName(@"zl_navCheckbox");
...
- (void)initBottomView
{
    ...
    _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, kViewHeight - 60, kViewWidth, 60)];
...
//        UIImage *normalImg = GetImageWithName(@"zl_btn_original_circle");
    ...
    _btnDone.frame = CGRectMake(kViewWidth - 82, 10, 80, 40);
