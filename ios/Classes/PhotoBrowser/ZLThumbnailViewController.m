...
- (void)viewDidLayoutSubviews
{
    ...
    CGFloat bottomViewH = showBottomView ? 60 : 0;
    CGFloat bottomBtnH = self.btnDone.layer.cornerRadius * 2.0;
    ...
    if (configuration.allowEditImage || configuration.allowEditVideo) {
        self.btnEdit.frame = CGRectMake(offsetX, 10, GetMatchValue(GetLocalLanguageTextValue(ZLPhotoBrowserEditText), 15, YES, bottomBtnH), bottomBtnH);
        offsetX = CGRectGetMaxX(self.btnEdit.frame) + 10;
    }
    self.btnPreView.frame = CGRectMake(offsetX, 10, GetMatchValue(GetLocalLanguageTextValue(ZLPhotoBrowserPreviewText), 15, YES, bottomBtnH), bottomBtnH);
    ...
    self.btnDone.frame = CGRectMake(width-doneWidth-16, 10, doneWidth, bottomBtnH);
...
- (void)setupBottomView
{
    ...
    self.btnDone.layer.cornerRadius = 20.0f;
